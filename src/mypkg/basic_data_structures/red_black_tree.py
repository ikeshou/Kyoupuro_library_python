"""
(参考) <Algorithm Introduction vol.1 p.256-p.274>
赤黒木
...
verified @AOJ ITP2_7_A
http://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=ITP2_7_A&lang=ja 
"""
...
class Vertex:
    def __init__(self, val: Any, color: bool, parent: Optional['Vertex']=None, left: Optional['Vertex']=None, right: Optional['Vertex']=None):
        self.val = val    # 順序関係 (__lt__, __gt__) さえ定義されていればどんなオブジェクトでも OK
        self.col = color
        self.p = parent
        self.l = left
        self.r = right
...
class RedBlcakTree:
    ...
    # 巡回、出力
    # =========
    def inorder_traverse(self, node: Optional[Vertex]=None) -> List[Any]:
        buf = []
    ...
    def preorder_traverse(self, node: Optional[Vertex]=None) -> List[Any]:
        buf = []
        node = self.root if node is None else node
        if node != self.nil:
            buf.append(node.val)
    ...
    def postorder_traverse(self, node: Optional[Vertex]=None) -> List[Any]:
        buf = []
        node = self.root if node is None else node
        if node != self.nil:
    ...
    # 基本的な探索
    # ===========
    def find(self, x: Any, node: Optional[Vertex]=None, key: Callable[[Any], Any]=lambda x: x) -> Union[Vertex, int]:
        """
    ...
    def min_node(self, node: Optional[Vertex]=None) -> Vertex:
        """
    ...
    def max_node(self, node:Optional[Vertex]=None) -> Vertex:
        """
    ...
    def successor(self, node: Vertex) -> Vertex:
        """
    ...
    def predecessor(self, node: Vertex) -> Vertex:
        """
    ...
    # 単回転、重回転処理 (補助操作)
    # =========================
    def _left_rotate(self, node: Vertex) -> None:
        # (O(1))
    ...
    def _right_rotate(self, node: Vertex) -> None:
    ...
    def _LR_rotate(self, node: Vertex) -> None:
        # (O(1))
    ...
    def _RL_rotate(self, node: Vertex) -> None:
    ...
    # 鉢植え処理 (補助操作)
    # ===================
    def _transplant(self, u_node: Vertex, v_node: Vertex) -> None:
        """
    ...
    def _insert_fixup(self, z: Vertex) -> None:
        """
    ...
    # 節点の削除
    # ========
    def delete(self, node: Vertex) -> None:
        """
    ...
    def _delete_fixup(self, y: Vertex) -> None:
        """
